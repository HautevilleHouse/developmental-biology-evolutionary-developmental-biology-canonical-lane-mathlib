import HautevilleHouse.DevelopmentalBiologyEvolutionaryDevelopmentalBiologyCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement :=
  { sourceKey := sourceRepository,
    ...
    manifoldConstrainedStatement := "evo-devo constrained theorem certificate internalized through baseline gates, source constants, reviewer bridge, manifest hashes, and outside-constant dependency count",
